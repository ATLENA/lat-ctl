...
public class LatApacheStartController extends LatController{
    ...
    protected void execute() throws IOException {
        ...
        log.debug("library link creating..");
        ...
        log.debug("apachectl temporary file creating..");
        ...
        log.debug("apachectl temporary file created");
